...
const Contact = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto my-12 [#129ee7] outline-green-800 lg:px-4">
      <Helmet>
        <title>Ekattor | Contact Us</title>
      </Helmet>
      ...
      >
        <div>
          ...
          <input
            ...
            required
            className="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-[#129ee7] outline-green-800"
